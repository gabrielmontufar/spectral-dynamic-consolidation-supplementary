...
REPO_URL = "https://github.com/gabrielmontufar/spectral-dynamic-consolidation-supplementary"
...
def build_docx(data: dict[str, pd.DataFrame]) -> Path:
    ...
    add_paragraph(doc, f"Data availability: The research data are synthetic and are generated by the reproducible scripts supplied with the manuscript. The supplementary repository contains the benchmark input parameters, spectral-retention calculations, finite-difference and finite-element verification results, figures and tables: {REPO_URL}.")
    add_paragraph(doc, f"Code availability: The Python scripts used to generate the numerical evidence, tables and figures are provided as supplementary material at {REPO_URL}.")
...
def write_declarations() -> None:
    docs = {
        ...
        "Submission declarations.docx": [
            ...
            (f"Data availability: The research data are synthetic and are generated by the reproducible scripts supplied with the manuscript. The supplementary repository contains benchmark input parameters, spectral-retention calculations, finite-difference and finite-element verification results, figures and tables: {REPO_URL}.", False),
            (f"Code availability: The Python scripts used to generate the numerical evidence, tables and figures are provided as supplementary material at {REPO_URL}.", False),
...
Public supplementary repository: {REPO_URL}
Figures: {FIG_DIR}
