...
This package contains synthetic benchmark data and reproducible Python scripts used to regenerate the retained-pressure curve, numerical verification, convergence checks, local and global sensitivity analyses, boundary-condition comparison, temporal source-history comparison, truncation-error bound check, and an external laboratory pressure-dissipation consistency check against public USGS Oso ring-shear consolidation records.
